...
var gpioDisplayer = function () {
  ...
  <div class="mb-4">
    ...
    <select onChange="gpioHelpers.changeValue(this.value, 'Pin')" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 text-sm" id="pinSelection">
      <option>PA0</option>
      <option>PA1</option>
      <option>PA2</option>
      <option>PA3</option>
